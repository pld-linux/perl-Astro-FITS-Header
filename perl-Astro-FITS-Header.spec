...
%description -l es
Módulo de Perl Astro::FITS::Header.
...
%description -l ja
Astro::FITS::Header Perl ¥â¥¸¥å¡¼¥ë

%description -l ko
Astro::FITS::Header ÆÞ ¸ðÁÙ.
...
%description -l pt_BR
Módulo Perl Astro::FITS::Header.

%description -l ru
íÏÄÕÌØ ÄÌÑ Perl Astro::FITS::Header.
